...
//  }
//
//  String updatePayNowTreasury(String cash) {
//    print("caaa2aaaaash is: 2aahhh "+cash);
//    double newCash = double.parse(cash) + double.parse(calculateBill());
...
//                          data: {"cash": updatePayNowTreasury(model.total[0].cash)});
//
